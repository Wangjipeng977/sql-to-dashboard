# Contributing to `User Provides Sql`
...
# 2. Clone your fork
git clone https://github.com/<your-username>/User Provides Sql.git
cd User Provides Sql
...
git add .
git commit -m "feat(sql-to-dashboard): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(sql-to-dashboard): add <brief description>
